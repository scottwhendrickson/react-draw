...
export default class extends PureComponent {
  ...
  getSaveData = () => {
    ...
    console.log('getSaveData '+this.lines);
    console.log('getSaveData '+this.props.canvasWidth);
  ...
  loadSaveData = (saveData, immediate = this.props.immediateLoading) => {
    ...
    if (typeof saveData !== "string") {
      console.log('loadSaveData saveData needs to be of type string! ');
      throw new Error("saveData needs to be of type string!");
    }

    
    const { lines, width, height } = JSON.parse(saveData);
    console.log('lines from const '+lines);
    console.log('width from const '+width);

    if (!lines || typeof lines.push !== "function") {
      console.log('saveData.lines needs to be an array!');
